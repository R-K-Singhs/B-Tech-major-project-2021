  ...
  sendRequestForSignup() {
    ...
    database
      ...
      .then((res) => {
        this.setState(
          {
            submit_status: `your data saved successfully`,
            spinner: false,
          },
          () => {
            document.getElementsByClassName("error-box")[0].focus();
      ...
      .catch((err) => {
        ...
        this.setState(
          {
            submit_status: "Your data is not Saved Please try again",
            spinner: false,
          },
          () => {
            document.getElementsByClassName("error-box")[0].focus();
    ...
    if (sessionStorage.getItem("studentId")) {
      ...
      return (
        <div className="container my-5">
          <div className="row m-0 w-100 border border-1">
            <div className="mx-auto ">
              <div className="row w-auto pb-4 bg-white">
                <h1 className="text-dark m-0 p-0 pb-1 ">
                  ...
                  <div className="w-100 p-0 m-0 text-center">
                    <span id="heading">Fill Your Details</span>
                    <hr className="mt-2 mb-1" />
                  </div>
                </h1>

                <div className="error-box row m-auto">
                  <span className=" rounded w-100 p-1 m-0" tabIndex="0">
